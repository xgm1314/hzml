...
class SmsCodeView(View):
    ...
    def get(self, request, mobile):
        ...
        redis_cli.setex('sms_%s' % mobile, 180, sms_code)  # 保存验证码
        redis_cli.setex('send_flag_%s' % mobile, 180, 1)  # 发送短信后,标记发送短信的标记
        ...
        CCP().send_template_sms(mobile, [sms_code, 3], 1)  # 发送验证码
